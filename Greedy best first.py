...
def generateGraph():
    ...
    h_n_cost = {'A': 30 / 2, 'B': 35 / 2, 'C': 24 / 2, 'D': 24 / 2, 'E': 20 / 2, 'F': 15 / 2, 'G': 15 / 2, 'H': 12 / 2,
                'I': 12 / 2,
...
graph2, visited, h_cost = generateGraph()
res, cost = GreedyBestFirst(graph=graph2, source='A', target='T', h_cost=h_cost, visited=visited)